defmodule RailCredo.Checks.LiveViewHandleParams do
  @moduledoc """
  ...
  The reason it's mandatory: several RailWeb on-mount hooks
  (`RailWeb.Hooks.DatePicker`, `RailWeb.Hooks.Filter`,
  `RailWeb.Hooks.RestoreFilters`) call `patch_params/2`, which uses
  ...
  Modules under `RailWeb.Hooks.*` and `RailWeb.Utils.*` are skipped:
