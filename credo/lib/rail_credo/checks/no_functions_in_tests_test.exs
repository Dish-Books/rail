defmodule RailCredo.Checks.NoFunctionsInTestsTest do
  use Credo.Test.Case, async: true

  alias RailCredo.Checks.NoFunctionsInTests

  test "allows setup_all for shared context" do
    """
    defmodule Rail.FooTest do
    ...
    """
    |> to_source_file("lib/rail/foo_test.exs")
  ...
  test "flags a public helper in a test file" do
    ...
    defmodule Rail.FooTest do
      ...
      def entity_with_location(scope) do
        insert(:entity, organization: scope.organization)
      end

      test "does a thing", %{scope: scope} do
        assert entity_with_location(scope)
      end
    end
    """
    |> to_source_file("lib/rail/foo_test.exs")
    ...
    |> assert_issue(fn issue ->
      ...
      assert issue.message =~ "entity_with_location"
    end)
  end
  ...
  test "flags a body helper while allowing a sibling nested fixture module" do
    ...
    defmodule Rail.FooTest do
      ...
      defmodule TestSchema do
        ...
        def changeset(item, attrs), do: cast(item, attrs, [])
      end
