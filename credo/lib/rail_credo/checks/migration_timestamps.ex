defmodule RailCredo.Checks.MigrationTimestamps do
  @moduledoc """
  ...
  runs.
      ...
      # bad
      priv/repo/migrations/20260806000000_add_location_to_bank_accounts.exs
      priv/repo/migrations/20260806120000_add_location_to_bank_accounts.exs

      # good
      priv/repo/migrations/20260807135753_add_location_to_bank_accounts.exs
